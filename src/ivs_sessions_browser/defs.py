...
HELP_TEXT = [
    ...
    "",
    "Manual sessions:",
    "  A/+ : Add inline (Type Code Start Dur Stations Ops Corr)",
    "  Tab / Shift+Tab : Move manual-add field",
    "  Enter / Esc : Save or cancel manual-add",
    "  Del : Delete selected manual session",
    "  CLI: --import-local imports .vex/.skd files",
    "",
    "Operators:",
    "  0 : Clear assignment",
    "  1-5 : Assign configured operator",
    "",
    "Exports:",
    "  P : Export visible rows to .pdf and open",
    "  X : Export visible rows to .xlsx and open",
    "",
    "Other:",
    "  q or Q : Quit",
    "  ? : Show this help",
